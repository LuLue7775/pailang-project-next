    ...
    <MotionBG variants={BGMotion} scrollHeight={scrollHeight} />
        { roles?.map(( elem, i ) => (
            ...
            >
                ...
                <StyledPersonaEn className='persona-en en' dangerouslySetInnerHTML={sanitizedData(elem?.introduction)}/>
                <StyledPersonaCh className='persona-ch zh' dangerouslySetInnerHTML={sanitizedData(elem?.introduction_zh)}/>
            </StyledPersonaContainer>
        )) || "" }
